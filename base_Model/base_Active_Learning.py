...
class base_Active_Learning_Decoder(base_Active_Learning):
    ...
    def base_random_select_training(self,eps=0.3,balance_prop=0.25,Select_Split=True,flag_initial=False,**kwargs):
    ...
    def train_BNN(self,flag_pretrain=False,flag_stream=False,flag_hybrid=False,target_dim=-1,conditional_coef=0.75,flag_results=False,**kwargs):
            ...
            for ep in range(epoch):
                ...
                if (ep+1)%100==0:
                    RMSE_test, MAE_test, NLL_test = Test_UCI_batch(self.model, self.test_input_tensor,
                                                                   ...
                                                                   sigma_out_scale=sigma_out, flag_fixed=True,
